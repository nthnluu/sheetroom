...
export default function () {
    const [flyoutOne, toggleFlyoutOne] = useState(false);
    const [flyoutTwo, toggleFlyoutTwo] = useState(false);
    return (
                ...
                <div
                    ...
                    <nav class="hidden md:flex space-x-10">
                        <div class="relative">
                            ...
                            <button type="button" onClick={() => toggleFlyoutOne(!flyoutOne)}
                            ...
                            {/*// -->*/}
                            <Transition show={flyoutOne} enter="transition ease-out duration-200" enterFrom="opacity-0 translate-y-1" enterTo="opacity-100 translate-y-0"
                                            ...
                                            <div class="z-20 relative grid gap-6 bg-white px-5 py-6 sm:gap-8 sm:p-8">
                                                <a href="#"
                                                   class="-m-3 p-3 flex items-start space-x-4 rounded-lg hover:bg-gray-50 transition ease-in-out duration-150">
                                                    <svg class="flex-shrink-0 h-6 w-6 text-blue-600" fill="none"
              ...
              <a href="#"
                ...
                Sign up
                                ...
                                <p class="text-center text-base leading-6 font-medium text-gray-500">
                                    Existing customer?
                                    <a href="#"
                                       class="text-blue-600 hover:text-blue-500 transition ease-in-out duration-150">
                                        Sign in
                                    </a>
                                </p>
                            </div>
