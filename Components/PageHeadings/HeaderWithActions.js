    ...
    return (
        <div className="flex items-center justify-between">
            <div className="flex-1 min-w-0">
                {editableTitle ? <input style={{textOverflow: "ellipsis"}} className="text-3xl w-full border-gray-100 font-bold leading-7 text-gray-900 sm:text-4xl sm:leading-9 sm:truncate border border-transparent hover:border-gray-400 rounded-lg p-2
