    ...
    return (
        <div className="flex items-center justify-between">
            <div className="flex-1 min-w-0">
                {editableTitle ? <input className="text-3xl font-bold leading-7 text-gray-900 sm:text-4xl sm:leading-9 sm:truncate border border-transparent hover:border-gray-300 rounded-lg p-2
