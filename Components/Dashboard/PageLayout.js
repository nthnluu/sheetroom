                ...
                <div className="flex-1 min-w-0 bg-white xl:flex">
                                        ...
                                        <div className="flex items-center space-x-3">
                                            ...
                                            <div className="space-y-1">
                                                ...
                                                <a href="#" className="group flex items-center space-x-2.5">
                                                    ...
                                                    <div className="text-sm leading-5 text-gray-500 group-hover:text-gray-900 font-medium">debbielewis</div>
                                                </a>
                                            </div>
                                        </div>
                                        {/* Action buttons */}
                    ...
                    <div className="bg-white lg:min-w-0 lg:flex-1">
                      ...
                      <span className="rounded-md shadow-sm">
                        <button id="sort-menu" onClick={() => toggleSortDropdown(!sortDropdown)} type="button" className="inline-flex justify-center w-full rounded-md border border-gray-300 px-4 py-2 bg-white text-sm leading-5 font-medium text-gray-700 hover:text-gray-500 focus:outline-none focus:border-blue-300 focus:shadow-outline-blue active:bg-gray-50 active:text-gray-800 transition ease-in-out duration-150" aria-haspopup="true" aria-expanded="false">
