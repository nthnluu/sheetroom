                    ...
                    <div className="flex items-center justify-start w-full">
                        <div className="flex items-center justify-start px-2 lg:px-0 w-full h-full"
                            ...
                            {session && !logoOnly ? <>
                                ...
                                <a href="/features"
                                   className={(darkText ? "text-gray-800 hover:opacity-75  focus:opacity-75 focus:shadow-outline" : "text-gray-200 hover:text-white  focus:text-white focus:bg-gray-800") + " px-3 py-2 rounded-md text-sm leading-5 font-medium focus:outline-none transition duration-150 ease-in-out"}>How it works</a>
                                {/*<a href="#"*/}
