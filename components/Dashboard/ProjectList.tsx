...
const ProjectList: React.FC<Props> = ({session, profileData}) => {
    ...
    return (
        <div className="bg-white lg:min-w-0 lg:flex-1 w-full">
            ...
            <div className="border-b border-gray-200 pb-8">
                <div
                    ...
                    <div className="flex items-center">
                        ...
                        <div>
                            {profileData.data.users_by_pk.account_type === "teacher" ? <NewTooltip title="New class" placement="bottom" enterDelay={500}
                                                                                                   enterNextDelay={500}>
            ...
            <div
                ...
                <div className="flex items-center">
                    ...
                    <div className="relative">
                        <div className="flex">
                            {profileData.data.users_by_pk.account_type === "teacher" ?  <NewTooltip title="New assignment" placement="bottom" enterDelay={500}
                                                                                                    enterNextDelay={500}>
            ...
            <AssignmentList profileData={profileData} session={session} openDialog={() => toggleCreateAssignmentDialog(true)}/>
        </div>)
}
