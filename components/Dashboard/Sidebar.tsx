                            ...
                            <div className="space-y-1">
                                ...
                                <a href="#" className="group flex items-center space-x-2.5">
                                    {profile.data.users_by_pk.account_type === "teacher" ? <div
                                        ...
                                        {profile.data.users_by_pk.is_pro ?  <div className="flex items-center space-x-2 bg-clip-text text-transparent bg-gradient-to-r from-yellow-300 to-orange-400">
