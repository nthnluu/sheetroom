...
const LeaveClassModal: React.FC<Props> = ({onCancel, isOpen, userId, classId}) => {
    ...
    return (<SimpleModal buttons={<div className="pt-2 mt-6 sm:mt-4 sm:flex sm:flex-row-reverse sm:justify-between">
        ...
        <button type="button" onClick={handleSubmit} disabled={isLoading}
         ...
         {isLoading ? <CircularProgress color="inherit" size={15} className="mr-2 h-auto"/> : null}Leave Class
        </button>
      </span>
        ...
        {/*@ts-ignore*/}
    </div>} isOpen={isOpen} onCancel={cancelModal} title="Leave class?" content={<div>
      <p className="text-sm leading-5 text-gray-500">
          You will stop receiving assignments from this class. You'll also loose any submissions associated with this class permanently.
