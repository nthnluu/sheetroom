            ...
            <div className="w-auto max-w-md">
                <div className="h-full divide-y divide-gray-200 flex flex-col bg-white">
                    <div className="flex-1 h-0 overflow-y-auto">
                        <header className="space-y-1 py-6 px-4 border-b border-gray-200 sm:px-6">
                            ...
                            <div className="space-y-2">
                                <button type="button"
                                        className="py-2 px-4 border w-full rounded-md text-sm leading-5 font-medium text-white bg-blue-600 hover:bg-blue-500 focus:outline-none focus:bg-blue-500 focus:shadow-outline-blue active:bg-blue-700 transition duration-150 ease-in-out">
                                    <i className="fas fa-clipboard-check mr-2"/>Assign to Course
                                </button>
                                <button type="button"
                                        className="py-2 px-4 border border-gray-300 w-full rounded-md text-sm leading-5 font-medium text-gray-700 hover:text-gray-500 focus:outline-none focus:border-blue-300 focus:shadow-outline-blue active:bg-gray-50 active:text-gray-800 transition duration-150 ease-in-out">
                                    <i className="fas fa-link mr-2"/>Copy Link
                                </button>
                                <button type="button"
                                        className="py-2 px-4 border border-gray-300 w-full rounded-md text-sm leading-5 font-medium text-gray-700 hover:text-gray-500 focus:outline-none focus:border-blue-300 focus:shadow-outline-blue active:bg-gray-50 active:text-gray-800 transition duration-150 ease-in-out">
                                    <i className="fas fa-print mr-2"/>Generate Print Version
                                </button>
                                ...
                                <div className="space-y-6 pt-6 pb-5">
                                    <div className="space-y-1">
                                        ...
                                        <div className="relative rounded-md shadow-sm">
                                                        <textarea id="description" rows="4" value={data.assignments_assignment_by_pk.description}
