                                ...
                                <div className="max-w-md mx-auto space-y-4 lg:max-w-5xl lg:grid lg:grid-cols-2 lg:gap-5 lg:space-y-0">
                                    <div className="flex flex-col rounded-lg shadow-lg overflow-hidden">
                                        <div className="px-6 py-8 bg-white sm:p-10 sm:pb-6">
                                            <div>
                                                <h3 className="inline-flex px-4 py-1 rounded-full text-sm leading-5 font-semibold tracking-wide uppercase bg-blue-100 text-blue-600" id="tier-standard">
                                                    FREE FOREVER
                                                </h3>
                                            </div>
                                        ...
                                        <div className="flex-1 flex flex-col justify-between px-6 pt-6 pb-8 bg-gray-50 space-y-6 sm:p-10 sm:pt-6">
                                            ...
                                            {session ? (profileData.data.users_by_pk.is_pro ? <div className="rounded-md shadow">
                                                ...
                                                <span className="flex items-center opacity-50 justify-center px-5 py-3 border border-transparent text-base leading-6 font-medium rounded-md text-white bg-gray-900 hover:bg-gray-800 focus:outline-none focus:shadow-outline transition duration-150 ease-in-out" aria-describedby="tier-standard">
                                                    Current Plan
                                                </span>
                                            </div>) : null}
                                ...
                                <div className="rounded-lg bg-gray-100 px-6 py-8 sm:p-10 lg:flex lg:items-center">
                                    <div className="flex-1">
                                        ...
                                        <div className="mt-4 text-lg leading-7 text-gray-600">
                                            For organizations such as schools or districts who need additional control, custom account security, and support
                                        </div>
                                    </div>
