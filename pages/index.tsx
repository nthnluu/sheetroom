                        ...
                        <div className="relative max-w-xl mx-auto px-4 sm:px-6 lg:px-8 lg:max-w-screen-xl">
                            ...
                            <div className="relative">
                                ...
                                <p className="mt-4 max-w-3xl mx-auto text-center text-xl leading-7 text-gray-500">
                                    Stop wrestling with formatting or buggy LMS quizzes. Start writing beautiful assignments that look great on desktop, mobile, and paper.
                                </p>
                            </div>
                            ...
                            <div className="relative mt-12 lg:mt-24 lg:grid lg:grid-cols-2 lg:gap-8 lg:items-center">
                                <div className="relative">
                                    ...
                                    <p className="mt-3 text-lg leading-7 text-gray-500">
                                        Sheetroom makes creating assignments easy and fast.
                                    </p>
                                    ...
                                    <ul className="mt-10">
                                        <li>
                                            <div className="flex">
                                                ...
                                                <div className="ml-4">
                                                    <h5 className="text-lg leading-6 font-medium text-gray-900">Competitive
                                                        exchange rates</h5>
                                        ...
                                        <li className="mt-10">
                                            <div className="flex">
                                                ...
                                                <div className="ml-4">
                                                    <h5 className="text-lg leading-6 font-medium text-gray-900">No
                                                        hidden fees</h5>
                                                    <p className="mt-2 text-base leading-6 text-gray-500">
                                                        Lorem ipsum, dolor sit amet consectetur adipisicing elit.
                                                        Maiores impedit perferendis suscipit eaque, iste dolor
                                        ...
                                        <li className="mt-10">
                                            <div className="flex">
                                                ...
                                                <div className="ml-4">
                                                    <h5 className="text-lg leading-6 font-medium text-gray-900">Transfers
                                                        are instant</h5>
                                                    <p className="mt-2 text-base leading-6 text-gray-500">
                                                        Lorem ipsum, dolor sit amet consectetur adipisicing elit.
                                                        Maiores impedit perferendis suscipit eaque, iste dolor
